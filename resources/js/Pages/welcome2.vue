...
<template>
  ...
  <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
    ...
    <div class="relative min-h-screen min-w-screen flex items-center justify-start bg-cover bg-center ml-6">
      ...
      <div class="flex flex-col items-center w-1/4 ml-8">
          ...
          <header
            ...
            <nav
              ...
              <template v-else>
                <Link
                  :href="route('login')"
                  class="custom-color rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white"
                >
                  Log in
                </Link>
